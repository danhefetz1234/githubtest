...
title = tk.Label(scrollable_frame, text=" !ברוך הבא לדף ההתנדבות למען ניצולי שואה ", font=("Arial", 24, "bold"), bg="#3b5998", fg="white")
set_rtl(title)
...
male_checkbox = tk.Radiobutton(gender_frame, text="זכר", variable=gender_var, value="זכר", bg="#e6f2ff", font=("Arial", 12), anchor="w")
female_checkbox = tk.Radiobutton(gender_frame, text="נקבה", variable=gender_var, value="נקבה", bg="#e6f2ff", font=("Arial", 12), anchor="w")
...
# סקרולר גיל מ-1 עד 99
age_label = tk.Label(scrollable_frame, text=":בחר גיל", font=("Arial", 14), bg="#f0f0f0")
set_rtl(age_label)
age_label.pack(pady=10, anchor="e")

age_scale = tk.Scale(scrollable_frame, from_=1, to=99, orient="horizontal", length=300, bg="#f0f0f0")
age_scale.pack(pady=10)
...
listbox = tk.Listbox(scroll_frame, yscrollcommand=scrollbar.set, height=5, justify="right", font=("Arial", 12), bd=2, activestyle="dotbox")
problems = [
...
volunteer_checkbox = tk.Checkbutton(scrollable_frame, text="אני מתנדב", variable=status_var, onvalue="מתנדב", offvalue="זקוק לעזרה", bg="#e6f2ff", font=("Arial", 12), anchor="w")
